DESCRIPTION = "ExtUtils::Config is an abstraction around the %Config hash. By itself \
it is not a particularly interesting module by any measure, however it \
ties \
...
SRC_URI = "http://cpan.metacpan.org/authors/id/L/LE/LEONT/ExtUtils-Config-0.008.tar.gz"
